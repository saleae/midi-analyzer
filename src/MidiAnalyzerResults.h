...
enum MidiFrameType
{ // Note: something else had the keywords Start and Stop; appended '_' to these.
    Command,
    Data, // Meta, probably not used.
    NoteOff,
    NoteOn,
    Aftertouch,
    ...
    MSB,
    orphanedData, // Data
    BeginSystemExclusiveMessage,
    MIDITimeCodeQuarterFrame,
    SongPositionPointer,
    SongSelect, // non-musical commands
    F4,
    F5,
    TuneRequest,
    EndSystemExclusiveMessage, // Ditto
    TimingClock,
    F9,
    Start_,
    Continue,
